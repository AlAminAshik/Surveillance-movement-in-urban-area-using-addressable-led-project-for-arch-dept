...
int redStrip_station3 = 18;
int redStrip_station4 = 24;
int redStrip_station5 = 30;
int redStrip_station6 = 38;
int redStrip_station7 = 46;
int redStrip_station8 = 58;
int redStrip_station9 = 66;
int redStrip_station10 = 74;
int redStrip_station11 = 91;
int redStrip_station12 = 104;
int redStrip_station13 = 122;
int redStrip_station14 = 136;
int redStrip_exit = 142;

//red light is stationary while all other lights come out. so it is used twice
int redStrip_stations[17] = {redStrip_station0, redStrip_station1, redStrip_station1, redStrip_station2, redStrip_station3, redStrip_station4, redStrip_station5, redStrip_station6, redStrip_station7, redStrip_station8, redStrip_station9, redStrip_station10, redStrip_station11, redStrip_station12, redStrip_station13, redStrip_station14, redStrip_exit};
...
//data for yellow light (same strip as green light)
int yellowStrip_increment = -2;

//data for purple light (same strip as blue light)
int purpleStrip_increment = 2;

#define SPEED 150           //delay time for each transition

#define greenStrip_PIN 12
#define redStrip_PIN 11
#define blueStrip_PIN 10
...
void moveLed(int prevStation, int nextStation, Adafruit_NeoPixel &strip, uint8_t R, uint8_t G, uint8_t B) {
...
void moveALLLed(int prevStation, int nextStation, int R) {
  for(i=prevStation; i<nextStation; i++) {
    ...
    greenStrip.setPixelColor(i+1+yellowStrip_increment, greenStrip.Color(255, 165, 0)); //orange color
    greenStrip.setPixelColor(i+yellowStrip_increment, greenStrip.Color(0, 0, 0));
    blueStrip.setPixelColor(i+1+purpleStrip_increment, blueStrip.Color(128, 0, 128)); //purple color
    blueStrip.setPixelColor(i+purpleStrip_increment, blueStrip.Color(0, 0, 0));
...
void loop() {
  ...
  if (digitalRead(next_button) == LOW) {
    delay(10);
    if (digitalRead(next_button) == LOW) {
      stationCheck = (stationCheck + 1) % 17;
      ...
      else if (stationCheck == 16) clear_LEDs();
